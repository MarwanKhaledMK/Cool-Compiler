...
public class parse extends Parser {
	...
	*/
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			match(EOF);
					...
					((ProgramContext)_localctx).value =  new AST_.program(((ProgramContext)_localctx).cl.value, ((ProgramContext)_localctx).cl.value.get(0).lineNo);
	...
	public static class Class_listContext extends ParserRuleContext {
		public ArrayList<AST_.class_> value;
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).enterClass_list(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).exitClass_list(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof parseVisitor ) return ((parseVisitor<? extends T>)visitor).visitClass_list(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Class_listContext class_list() throws RecognitionException {
		...
		enterRule(_localctx, 2, RULE_class_list);
				...
				((Class_listContext)_localctx).value =  new ArrayList<AST_.class_>();
	...
	public static class Class_Context extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).enterClass_(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).exitClass_(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof parseVisitor ) return ((parseVisitor<? extends T>)visitor).visitClass_(this);
			else return visitor.visitChildren(this);
		}
	}
		...
		try {
			...
			case 1:
				...
				match(RBRACE);
						...
						((Class_Context)_localctx).value =  new AST_.class_(((Class_Context)_localctx).type.getText(), filename, "Object", ((Class_Context)_localctx).feature_list.value, ((Class_Context)_localctx).st.getLine());
			...
			case 2:
				...
				match(RBRACE);
						...
						((Class_Context)_localctx).value =  new AST_.class_(((Class_Context)_localctx).type.getText(), filename, ((Class_Context)_localctx).p_type.getText(), ((Class_Context)_localctx).feature_list.value, ((Class_Context)_localctx).st.getLine());
	...
	public static class Feature_listContext extends ParserRuleContext {
		public ArrayList<AST_.feature> value;
	...
	public final Feature_listContext feature_list() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_feature_list);
				...
				((Feature_listContext)_localctx).value =  new ArrayList<AST_.feature>();
	...
	public static class AttrContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).enterAttr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).exitAttr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof parseVisitor ) return ((parseVisitor<? extends T>)visitor).visitAttr(this);
			else return visitor.visitChildren(this);
		}
	}
		...
		try {
			...
			case 1:
				...
				((AttrContext)_localctx).type = match(TYPEID);
						...
						((AttrContext)_localctx).value =  new AST_.attr(((AttrContext)_localctx).id.getText(), ((AttrContext)_localctx).type.getText(), new AST_.no_expr(((AttrContext)_localctx).id.getLine()), ((AttrContext)_localctx).id.getLine());
			...
			case 2:
				...
				((AttrContext)_localctx).expr = expression(0);
						...
						((AttrContext)_localctx).value =  new AST_.attr(((AttrContext)_localctx).id.getText(), ((AttrContext)_localctx).type.getText(), ((AttrContext)_localctx).expr.value, ((AttrContext)_localctx).id.getLine());
		...
		try {
			...
			case 1:
				...
				match(RBRACE);
						...
						((MethodContext)_localctx).value =  new AST_.method(((MethodContext)_localctx).id.getText(), new ArrayList<AST_.formal>(), ((MethodContext)_localctx).type.getText(), ((MethodContext)_localctx).expr.value, ((MethodContext)_localctx).id.getLine());
			...
			case 2:
				...
				match(RBRACE);
						...
						((MethodContext)_localctx).value =  new AST_.method(((MethodContext)_localctx).id.getText(), ((MethodContext)_localctx).fr_list.value, ((MethodContext)_localctx).type.getText(), ((MethodContext)_localctx).expr.value, ((MethodContext)_localctx).id.getLine());
	...
	public static class Formal_listContext extends ParserRuleContext {
		public ArrayList<AST_.formal> value;
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).enterFormal_list(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).exitFormal_list(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof parseVisitor ) return ((parseVisitor<? extends T>)visitor).visitFormal_list(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Formal_listContext formal_list() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_formal_list);
				...
				((Formal_listContext)_localctx).value =  new ArrayList<AST_.formal>();
	...
	public final FormalContext formal() throws RecognitionException {
		...
		try {
			...
			((FormalContext)_localctx).type = match(TYPEID);
					...
					((FormalContext)_localctx).value =  new AST_.formal(((FormalContext)_localctx).id.getText(), ((FormalContext)_localctx).type.getText(), ((FormalContext)_localctx).id.getLine()) ;
	...
	public static class Expression_listContext extends ParserRuleContext {
		public ArrayList<AST_.expression> value;
		public ExpressionContext expr;
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).enterExpression_list(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).exitExpression_list(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof parseVisitor ) return ((parseVisitor<? extends T>)visitor).visitExpression_list(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Expression_listContext expression_list() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_expression_list);
				...
				((Expression_listContext)_localctx).value =  new ArrayList<AST_.expression>();
	...
	public static class Block_expr_listContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).enterBlock_expr_list(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).exitBlock_expr_list(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof parseVisitor ) return ((parseVisitor<? extends T>)visitor).visitBlock_expr_list(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Block_expr_listContext block_expr_list() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_block_expr_list);
				...
				((Block_expr_listContext)_localctx).value =  new ArrayList<AST_.expression>();
	...
	public static class Branch_listContext extends ParserRuleContext {
		public ArrayList<AST_.branch> value;
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).enterBranch_list(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).exitBranch_list(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof parseVisitor ) return ((parseVisitor<? extends T>)visitor).visitBranch_list(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Branch_listContext branch_list() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_branch_list);
				...
				((Branch_listContext)_localctx).value =  new ArrayList<AST_.branch>();
	...
	public static class BranchContext extends ParserRuleContext {
		public AST_.branch value;
		public Token id;
		public Token type;
		public ExpressionContext expr;
		public TerminalNode COLON() { return getToken(parse.COLON, 0); }
		public TerminalNode DARROW() { return getToken(parse.DARROW, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).enterBranch(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).exitBranch(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof parseVisitor ) return ((parseVisitor<? extends T>)visitor).visitBranch(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final BranchContext branch() throws RecognitionException {
		...
		try {
			...
			match(SEMICOLON);
					...
					((BranchContext)_localctx).value =  new AST_.branch(((BranchContext)_localctx).id.getText(), ((BranchContext)_localctx).type.getText(), ((BranchContext)_localctx).expr.value, ((BranchContext)_localctx).id.getLine());
	...
	public static class Let_listContext extends ParserRuleContext {
		public ArrayList<AST_.attr> value;
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).enterLet_list(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof parseListener ) ((parseListener)listener).exitLet_list(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof parseVisitor ) return ((parseVisitor<? extends T>)visitor).visitLet_list(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Let_listContext let_list() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_let_list);
				...
				((Let_listContext)_localctx).value =  new ArrayList<AST_.attr>();
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public TerminalNode TILDE() { return getToken(parse.TILDE, 0); }
		public List<ExpressionContext> expression() {
			return getRuleContexts(ExpressionContext.class);
		}
		public ExpressionContext expression(int i) {
		...
		public TerminalNode TYPEID() { return getToken(parse.TYPEID, 0); }
		public TerminalNode INT_CONST() { return getToken(parse.INT_CONST, 0); }
		public TerminalNode STR_CONST() { return getToken(parse.STR_CONST, 0); }
		public TerminalNode BOOL_CONST() { return getToken(parse.BOOL_CONST, 0); }
		public TerminalNode STAR() { return getToken(parse.STAR, 0); }
		public TerminalNode SLASH() { return getToken(parse.SLASH, 0); }
		public TerminalNode PLUS() { return getToken(parse.PLUS, 0); }
		public TerminalNode MINUS() { return getToken(parse.MINUS, 0); }
		public TerminalNode LT() { return getToken(parse.LT, 0); }
		public TerminalNode LE() { return getToken(parse.LE, 0); }
		public TerminalNode EQUALS() { return getToken(parse.EQUALS, 0); }
		...
		try {
			...
			case 1:
				...
				match(RPAREN);
						...
						((ExpressionContext)_localctx).value =  new AST_.dispatch(new AST_.object("self" , ((ExpressionContext)_localctx).id.getLine()) , ((ExpressionContext)_localctx).id.getText() , ((ExpressionContext)_localctx).expr_list.value , ((ExpressionContext)_localctx).id.getLine());
			...
			case 2:
				...
				((ExpressionContext)_localctx).e1 = expression(22);
							...
							((ExpressionContext)_localctx).value =  new AST_.comp(((ExpressionContext)_localctx).e1.value, ((ExpressionContext)_localctx).st.getLine());
			...
			case 3:
				...
				((ExpressionContext)_localctx).expr = expression(21);
							...
							((ExpressionContext)_localctx).value =  new AST_.isvoid(((ExpressionContext)_localctx).expr.value, ((ExpressionContext)_localctx).st.getLine());
			...
			case 4:
				...
				((ExpressionContext)_localctx).e1 = expression(13);
							...
							((ExpressionContext)_localctx).value =  new AST_.neg(((ExpressionContext)_localctx).e1.value, ((ExpressionContext)_localctx).st.getLine());
			...
			case 5:
				...
				((ExpressionContext)_localctx).expr = expression(12);
							...
							((ExpressionContext)_localctx).value =  new AST_.assign(((ExpressionContext)_localctx).id.getText(), ((ExpressionContext)_localctx).expr.value, ((ExpressionContext)_localctx).id.getLine());
			...
			case 6:
				...
				match(FI);
							...
							((ExpressionContext)_localctx).value =  new AST_.cond(((ExpressionContext)_localctx).predicate.value, ((ExpressionContext)_localctx).ifbody.value, ((ExpressionContext)_localctx).elsebody.value, ((ExpressionContext)_localctx).st.getLine());
			...
			case 7:
				...
				match(POOL);
							...
							((ExpressionContext)_localctx).value =  new AST_.loop(((ExpressionContext)_localctx).predicate.value, ((ExpressionContext)_localctx).body.value, ((ExpressionContext)_localctx).st.getLine());
			...
			case 8:
				...
				match(RBRACE);
							...
							((ExpressionContext)_localctx).value =  new AST_.block(((ExpressionContext)_localctx).el.value, ((ExpressionContext)_localctx).st.getLine());
			...
			case 9:
				...
				((ExpressionContext)_localctx).e1 = expression(8);
						...
						for(int i = ((ExpressionContext)_localctx).ll.value.size() - 1; i >= 0; --i)
						{
							...
							((ExpressionContext)_localctx).value =  new AST_.let(this_attr.name, this_attr.typeid, this_attr.value, _localctx.value, ((ExpressionContext)_localctx).st.getLine());
						}
			...
			case 10:
				...
				match(ESAC);
					// define
							((ExpressionContext)_localctx).value =  new AST_.typcase(((ExpressionContext)_localctx).predicate.value, ((ExpressionContext)_localctx).bl.value, ((ExpressionContext)_localctx).st.getLine());
			...
			case 11:
				...
				((ExpressionContext)_localctx).type = match(TYPEID);
							...
							((ExpressionContext)_localctx).value =  new AST_.new_(((ExpressionContext)_localctx).type.getText(), ((ExpressionContext)_localctx).st.getLine());
			...
			case 13:
				...
				((ExpressionContext)_localctx).id = match(OBJECTID);
							...
							((ExpressionContext)_localctx).value =  new AST_.object(((ExpressionContext)_localctx).id.getText(), ((ExpressionContext)_localctx).id.getLine());
			...
			case 14:
				...
				((ExpressionContext)_localctx).v = match(INT_CONST);
							...
							((ExpressionContext)_localctx).value =  new AST_.int_const(Integer.parseInt(((ExpressionContext)_localctx).v.getText()), ((ExpressionContext)_localctx).v.getLine());
			...
			case 15:
				...
				((ExpressionContext)_localctx).v = match(STR_CONST);
							...
							((ExpressionContext)_localctx).value =  new AST_.string_const(((ExpressionContext)_localctx).v.getText(), ((ExpressionContext)_localctx).v.getLine());
			...
			case 16:
				...
				((ExpressionContext)_localctx).v = match(BOOL_CONST);
							...
							((ExpressionContext)_localctx).value =  new AST_.bool_const(((ExpressionContext)_localctx).v.getText().charAt(0)=='t', ((ExpressionContext)_localctx).v.getLine());
				...
				if ( _alt==1 ) {
					...
					case 1:
						...
						((ExpressionContext)_localctx).e2 = expression(21);
						          			...
						          			((ExpressionContext)_localctx).value =  new AST_.mul(((ExpressionContext)_localctx).e1.value, ((ExpressionContext)_localctx).e2.value, ((ExpressionContext)_localctx).e1.value.lineNo);
					...
					case 2:
						...
						((ExpressionContext)_localctx).e2 = expression(20);
						          			...
						          			((ExpressionContext)_localctx).value =  new AST_.divide(((ExpressionContext)_localctx).e1.value, ((ExpressionContext)_localctx).e2.value, ((ExpressionContext)_localctx).e1.value.lineNo);
					...
					case 3:
						...
						((ExpressionContext)_localctx).e2 = expression(19);
						          			...
						          			((ExpressionContext)_localctx).value =  new AST_.plus(((ExpressionContext)_localctx).e1.value, ((ExpressionContext)_localctx).e2.value, ((ExpressionContext)_localctx).e1.value.lineNo);
					...
					case 4:
						...
						((ExpressionContext)_localctx).e2 = expression(18);
						          			...
						          			((ExpressionContext)_localctx).value =  new AST_.sub(((ExpressionContext)_localctx).e1.value, ((ExpressionContext)_localctx).e2.value, ((ExpressionContext)_localctx).e1.value.lineNo);
					...
					case 5:
						...
						((ExpressionContext)_localctx).e2 = expression(17);
						          			...
						          			((ExpressionContext)_localctx).value =  new AST_.lt(((ExpressionContext)_localctx).e1.value, ((ExpressionContext)_localctx).e2.value, ((ExpressionContext)_localctx).e1.value.lineNo);
					...
					case 6:
						...
						((ExpressionContext)_localctx).e2 = expression(16);
						          			...
						          			((ExpressionContext)_localctx).value =  new AST_.leq(((ExpressionContext)_localctx).e1.value, ((ExpressionContext)_localctx).e2.value, ((ExpressionContext)_localctx).e1.value.lineNo);
					...
					case 7:
						...
						((ExpressionContext)_localctx).e2 = expression(15);
						          			...
						          			((ExpressionContext)_localctx).value =  new AST_.eq(((ExpressionContext)_localctx).e1.value, ((ExpressionContext)_localctx).e2.value, ((ExpressionContext)_localctx).e1.value.lineNo);
					...
					case 8:
						...
						match(RPAREN);
						          		...
						          		((ExpressionContext)_localctx).value =  new AST_.dispatch(((ExpressionContext)_localctx).expr.value, ((ExpressionContext)_localctx).id.getText(), ((ExpressionContext)_localctx).expr_list.value, ((ExpressionContext)_localctx).expr.value.lineNo);
					...
					case 9:
						...
						match(RPAREN);
						          		...
						          		((ExpressionContext)_localctx).value =  new AST_.static_dispatch(((ExpressionContext)_localctx).expr.value, ((ExpressionContext)_localctx).type.getText(), ((ExpressionContext)_localctx).id.getText(), ((ExpressionContext)_localctx).expr_list.value, ((ExpressionContext)_localctx).expr.value.lineNo);
	...
	public static final String _serializedATN =
		...
		"\5F\13\5\3\6\3\6\3\6\3\6\3\6\3\6\5\6N\n\6\3\7\3\7\3\7\3\7\3\7\3\7\3\7"+
		"\3\7\3\7\3\7\3\7\5\7[\n\7\3\b\3\b\3\b\3\b\3\b\3\b\3\b\3\b\3\b\3\b\3\b"+
		"\3\b\3\b\3\b\3\b\3\b\3\b\3\b\3\b\3\b\3\b\5\br\n\b\3\t\3\t\3\t\3\t\3\t"+
		...
		"\f\16\20\22\24\26\30\32\34\36\2\2\2\u014e\2 \3\2\2\2\4(\3\2\2\2\6<\3\2"+
		"\2\2\bD\3\2\2\2\nM\3\2\2\2\fZ\3\2\2\2\16q\3\2\2\2\20s\3\2\2\2\22~\3\2"+
		"\2\2\24\u008e\3\2\2\2\26\u0094\3\2\2\2\30\u009c\3\2\2\2\32\u00a0\3\2\2"+
		"\2\34\u00a8\3\2\2\2\36\u00fd\3\2\2\2 !\5\4\3\2!\"\7\2\2\3\"#\b\2\1\2#"+
		"\3\3\2\2\2$%\5\6\4\2%&\7\r\2\2&\'\b\3\1\2\')\3\2\2\2($\3\2\2\2)*\3\2\2"+
		"\2*(\3\2\2\2*+\3\2\2\2+\5\3\2\2\2,-\7\34\2\2-.\7\4\2\2./\7\26\2\2/\60"+
		"\5\b\5\2\60\61\7\27\2\2\61\62\b\4\1\2\62=\3\2\2\2\63\64\7\34\2\2\64\65"+
		"\7\4\2\2\65\66\7!\2\2\66\67\7\4\2\2\678\7\26\2\289\5\b\5\29:\7\27\2\2"+
		":;\b\4\1\2;=\3\2\2\2<,\3\2\2\2<\63\3\2\2\2=\7\3\2\2\2>?\5\n\6\2?@\7\r"+
		"\2\2@A\b\5\1\2AC\3\2\2\2B>\3\2\2\2CF\3\2\2\2DB\3\2\2\2DE\3\2\2\2E\t\3"+
		"\2\2\2FD\3\2\2\2GH\5\16\b\2HI\b\6\1\2IN\3\2\2\2JK\5\f\7\2KL\b\6\1\2LN"+
		"\3\2\2\2MG\3\2\2\2MJ\3\2\2\2N\13\3\2\2\2OP\7\5\2\2PQ\7\13\2\2QR\7\4\2"+
